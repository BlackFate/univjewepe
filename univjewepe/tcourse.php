    ...
    <header class="px-5">
      <div class="text-white">
        ...
        <nav class="nav nav-masthead justify-content-center float-md-end">
          ...
          <a class="nav-link fw-bold py-1 px-0 active" aria-current="page" href="tcourse.php">Kursus</a>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form method="post" enctype="multipart/form-data">
                  ...
                  <label for="Lama" class="mt-2" style="color: black;">Masukkan lama waktu pelatihan (Hari): </label>
