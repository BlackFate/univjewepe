  ...
  <div class="d-flex w-100 h-100 p-3 mx-auto flex-column">
    ...
    <div class="container-lg mt-5 text-left text-white">
      <div class="row">
        ...
        <!-- Modal Tambah Data-->
        <div>
          <button type="button" class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#courseModal">Tambah Data</button>
        </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form method="post" enctype="multipart/form-data">
                  <label for="NamaPelajar" class="mt-2" style="color: black;">Masukkan nama pelajar: </label>
                  <input type="text" id="NamaPelajar" name="NamaPelajar" class="form-control">
                  <label for="KelasPelajar" class="mt-2" style="color: black;">Masukkan kelas pelajar: </label>
                  <input type="text" id="KelasPelajar" name="KelasPelajar" class="form-control">
                  <label for="NimPelajar" class="mt-2" style="color: black;">Masukkan NPM: </label>
                  <input type="text" id="NimPelajar" name="NimPelajar" class="form-control">
                  <input type="submit" value="Submit" name="InputPelajar" class="btn btn-success mt-2">
                </form>
              </div>
